    ...
    render() {
        return (
            <View style={[styles.navBar,
                ...
                <Text style = {[styles.title,{color:this.props.titleTextColor}]} numberOfLines={1}>
                    {this.props.title}
                </Text>
                {
                    this.props.actionName
                        ? <TouchableOpacity style={[styles.actionBtn, {bottom: (NAV_BAR_HEIGHT - 18 )/ 2}]} onPress={this.props.actionFunc.bind(this)}>
